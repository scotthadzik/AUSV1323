...
def setup(): 
	...
	time.sleep(2)
	relayB1Short.setRelayStatus(True)
	time.sleep(2)
	relayB1Resist.setRelayStatus(True)
	time.sleep(2)
	relayB1Fault.setRelayStatus(False)
	time.sleep(2)
	relayB1Short.setRelayStatus(False)
	time.sleep(2)
	relayB1Resist.setRelayStatus(False)
	time.sleep(2)
